...
class ReloadUserImages extends AbstractFixture
    ...
    ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        try {
            ...
            $finder = new Finder();
            $finder->files()->in('/home/zach/Downloads/stock_pictures_from_morguefile/');
            $imgs = iterator_to_array($finder);
            ...
            foreach ($musicians as $musicians) {
                ...
                $document->setAssociation($musicians);
                $this->manager->persist($musicians);
            }
            $this->manager->flush();
