...
class ClientCreateCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('ze:babundle:client:create')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf('oauth/v2/token?client_id=<info>%s</info>&client_secret=<info>%s</info>&grant_type=client_credentials', $client->getPublicId(), $client->getSecret()));
    }
}
